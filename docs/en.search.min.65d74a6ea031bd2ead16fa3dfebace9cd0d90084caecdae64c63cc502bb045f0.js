...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.20bfa821f66d5dee52105d3165f85ec9f4df738a4fc45862ebe998a8384caaa2.js',function(){input.required=false;search();});}
