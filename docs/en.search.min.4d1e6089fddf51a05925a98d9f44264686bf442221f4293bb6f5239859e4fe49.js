...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.0db7853deb0091270168669fbcbc860bc6f2a151f884e5bf83a77616328a1d65.js',function(){input.required=false;search();});}
