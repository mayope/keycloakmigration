...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.ddb5455aaa83a996162c3ad06287f48a48a02158052439ca1b9b2407d5232bf9.js',function(){input.required=false;search();});}
