...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.d6143513241a7a4d31a7649f76e7e38aac33b0fa58077d14a79980bad619ef98.js',function(){input.required=false;search();});}
