...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.e30202e0416e9a09b958673c303f870fd07d74b8114785c8dca155b432cd68d5.js',function(){input.required=false;search();});}
