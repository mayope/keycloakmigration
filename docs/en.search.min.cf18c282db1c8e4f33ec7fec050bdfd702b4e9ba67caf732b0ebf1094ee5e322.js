...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.d5b24951b85be6b02349dfad0113a6bfe4d63485b70bd7df499cb7ca490601d8.js',function(){input.required=false;search();});}
