...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.0140c651cd42743446eb4d55ec0a3a452ec05899f7f6daaa460d1a4e50d71345.js',function(){input.required=false;search();});}
