...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.c13b57c0de65db6fa0f53121e69a57f571af2ae07e59c0794f1c4a7d150f981f.js',function(){input.required=false;search();});}
