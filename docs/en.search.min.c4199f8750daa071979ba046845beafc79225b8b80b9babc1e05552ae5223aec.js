...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.ef2def1668dbdbf81bea0ef80de2b6b3b8310446b3dad415a5c07b13666c36e8.js',function(){input.required=false;search();});}
