...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.63e8fa0e0f0addc0b457c998d972a77f3272f8bdc7d0f4c6594c905e3a6e3709.js',function(){input.required=false;search();});}
