...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.c4a5dd6b098fc01c3febeed276a0da3c87c79ea91d3e53b08b0bb94290a53cc9.js',function(){input.required=false;search();});}
