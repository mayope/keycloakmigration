...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.e034a0d2cd7dc412ef6551b441322f85e1670d4436780999839d33e1767a28eb.js',function(){input.required=false;search();});}
