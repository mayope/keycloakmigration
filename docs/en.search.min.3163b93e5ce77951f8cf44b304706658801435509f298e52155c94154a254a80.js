...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.14ddc9bb5a527b652b3438ada8215522400706c2bfc2fdd0e22ceba13e8d93b5.js',function(){input.required=false;search();});}
