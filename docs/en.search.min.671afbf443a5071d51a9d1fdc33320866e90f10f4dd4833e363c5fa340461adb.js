...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.f47cbb8db9b30a1e2e61ba33e89c358b4a3bedd3553c2d21dbd0e4047be05309.js',function(){input.required=false;search();});}
