...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.ea3d445de9eec42e0d6ef6a8765e2995f2999a713307a8c4bb76dcb7e5114bb0.js',function(){input.required=false;search();});}
