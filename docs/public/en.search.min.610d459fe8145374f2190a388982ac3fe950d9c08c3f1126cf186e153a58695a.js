...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.2333e88a10930c4cfdfe9f461f38072c5266aa0bd8684151190b154aeafa2ed6.js',function(){input.required=false;search();});}
