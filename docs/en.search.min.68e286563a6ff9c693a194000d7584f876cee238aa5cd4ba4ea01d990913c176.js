...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.16be29128ba12bc4548651b33b6b82d1452d8fe3fae61c885d0d26dfd76cf581.js',function(){input.required=false;search();});}
