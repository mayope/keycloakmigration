...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.2549b7097f97a1d657371bb63dbd765382fd82f853531a404d4fa39faef297e1.js',function(){input.required=false;search();});}
