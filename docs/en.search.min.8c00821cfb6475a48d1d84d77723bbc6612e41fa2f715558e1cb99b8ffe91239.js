...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.83b3be4e3ece5204a6481bb7045f15282e22842e3ab80f48e3db88d5106dab44.js',function(){input.required=false;search();});}
