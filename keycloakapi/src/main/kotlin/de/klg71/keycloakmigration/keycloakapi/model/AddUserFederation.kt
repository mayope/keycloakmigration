...
fun bindCredential(config: Map<String, String>) = config["bindCredential"]
        ?: throw KeycloakApiException("BindCredential on ldap not given!")

fun bindDN(config: Map<String, String>) = config["bindDn"] ?: throw KeycloakApiException("BindDn on ldap not given!")

fun authenticationType(config: Map<String, String>) = config["authenticationType"] ?: "simple"

fun usersDN(config: Map<String, String>) = config["usersDn"] ?: throw KeycloakApiException("UsersDn on ldap not given!")

fun connectionUrl(config: Map<String, String>) = config["connectionUrl"]
        ?: throw KeycloakApiException("connectionUrl on ldap not given!")
