...
fun KeycloakClient.mapperExistsByName(clientScopeName: String, mapperName: String, realm: String) =
    mappers(clientScopeUUID(clientScopeName, realm), realm).any { it.name == mapperName }
