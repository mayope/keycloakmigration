...
fun addKeycloakIdentityProvider(
    ...
    "keycloak-oidc", alias, displayName, enabled, mapOf(
        ...
        "backchannelSupported" to backchannelSupported.toString().lowercase(),
        "clientAuthMethod" to clientAuthMethod,
        "clientId" to clientId,
        "clientSecret" to clientSecret,
        "defaultScope" to defaultScopes.joinToString(","),
        "disableUserInfo" to disableUserInfo.toString().lowercase(),
        "forwardParameters" to forwardParameters.joinToString(","),
        "guiOrder" to guiOrder,
        "hideOnLoginPage" to hideOnLoginPage.toString().lowercase(),
        "issuer" to issuer,
        "loginHint" to loginHint.toString().lowercase(),
        "logoutUrl" to logoutUrl,
        "syncMode" to syncMode,
        "tokenUrl" to tokenUrl,
        "uiLocales" to uiLocales.toString().lowercase(),
        "useJwksUrl" to useJwksUrl.toString().lowercase(),
