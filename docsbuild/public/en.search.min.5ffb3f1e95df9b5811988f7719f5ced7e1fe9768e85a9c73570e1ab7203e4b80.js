...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/keycloakmigration/flexsearch.min.js');loadScript('/keycloakmigration/en.search-data.min.7cd6404025eb0af3eca4b61d6fca7e8edd9d99b40056e4c61bea58907d2aaa5a.js',function(){input.required=false;search();});}
