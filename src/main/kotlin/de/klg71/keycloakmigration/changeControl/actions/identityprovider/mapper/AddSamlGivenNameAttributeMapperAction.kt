...
import de.klg71.keycloakmigration.keycloakapi.model.givenNameMapper

internal class AddSamlGivenNameAttributeMapperAction(
    realm: String? = null,
    ...
    private fun addIdentityProviderMapper(): AddIdentityProviderMapper =
        givenNameMapper(identityProviderAlias, name, attributeName)
