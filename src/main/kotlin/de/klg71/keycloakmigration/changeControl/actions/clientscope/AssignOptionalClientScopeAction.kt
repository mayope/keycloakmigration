...
class AssignOptionalClientScopeAction(
        realm: String?,
    ...
    override fun execute() {
        ...
        client.assignOptionalClientScope(realm(), clientUUID,
    ...
    override fun undo() {
        ...
        client.withdrawOptionalClientScope(realm(), clientUUID, clientScopeUUID)
    }

    override fun name() = "AssignOptionalClientScope $clientScopeName to client: $clientId"
