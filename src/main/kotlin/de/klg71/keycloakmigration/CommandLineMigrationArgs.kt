...
internal class CommandLineMigrationArgs(parser: ArgParser) :
    ...
    private val waitForKeycloak by parser.flagging(names = *arrayOf("--wait-for-keycloak"),
            help = "Wait for Keycloak to become ready, defaulting to $DEFAULT_WAIT_FOR_KEYCLOAK.").default(
    ...
    private val failOnUndefinedVariables by parser.flagging(names = *arrayOf("--fail-on-undefined-variables"),
