 ...
 */
object TestMigrationArgsClient : MigrationArgs {
    ...
    override fun migrationFile() = "src/test/resources/keycloak-changelog-client.yml"
    override fun realm() = DEFAULT_REALM
    override fun clientId() = "test"
    override fun clientSecret() = "lq3YBoZk2aYFTz8uba3gAI3Yek1AZqUS"

    override fun loginWithClientSecret() = true
